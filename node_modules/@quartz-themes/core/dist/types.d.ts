...
type AspectKey = "base" | "headings" | "typography" | "callouts" | "tables" | "code" | "links" | "blockquotes" | "checkboxes" | "images" | "embeds" | "cards" | "search" | "scrollbars" | "explorer" | "toc" | "graph" | "popover" | "footer" | "recentNotes" | "listPage" | "darkmode" | "breadcrumbs" | "lists" | "canvas" | "bases" | "properties" | "stacked" | "misc";
/** Per-aspect CSS strings for a single mode (dark or light). */
type AspectCSS = Partial<Record<AspectKey, string>>;
...
interface ClassSettingCSS {
    general?: string;
    dark?: string;
    light?: string;
}
interface SelectorImpactRecord {
    impacts: SelectorImpact[];
    interactionGroups: SelectorInteractionGroup[];
}
interface SelectorImpact {
    settingId: string;
    sectionId: string;
    settingType: string;
    effectKind: string;
    ...
    pathKind: "body-class" | "css-variable" | "derived-variable" | "gradient-variable";
    direct: boolean;
...
interface RuntimeSelectorImpactEvidence {
    observed: boolean;
...
interface RuntimeCssVariableChange {
    name: string;
    before?: string;
    after?: string;
}
interface RuntimeComputedStyleChange {
    selector: string;
    property: string;
    before?: string;
    after?: string;
}
interface SelectorInteractionGroup {
    interactionGroup: string;
    interactionMode: string;
    mode: "both" | "dark" | "light";
    settingIds: string[];
...
interface ThemeOptions {
     ...
     */
    calloutStyle?: string;
    /** Whether to include the theme's @font-face declarations. @default true */
    themeFonts?: boolean;
    /** Font overrides. */
    fonts?: {
        header?: string;
...
export type { AspectCSS, AspectKey, ClassSettingCSS, FontFileEntry, RuntimeComputedStyleChange, RuntimeCssVariableChange, RuntimeSelectorImpactEvidence, SelectorImpact, SelectorImpactRecord, SelectorInteractionGroup, ThemeData, ThemeMeta, ThemeModule, ThemeOptions };
